...
TEST_F(ActivityListSuite, GetCommitments) {
    ...
    Commitment c(Date(14, 10, 18), Date(14, 10, 18), Time(static_cast<unsigned>(14), static_cast<unsigned>(00), static_cast<unsigned>(00)), Time(static_cast<unsigned>(60),static_cast<unsigned>(00), static_cast<unsigned>(00)), false, std::string("This is a note, again"), std::string("www.boh.com"));
        al->addCommitment(c);
